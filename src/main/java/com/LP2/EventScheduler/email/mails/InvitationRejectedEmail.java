...
public class InvitationRejectedEmail implements EmailContent {
    @Override
    public String getSubject() {
        return "Invitation rejected - Master Event Planner";
    }
    ...
    public String getBody(Map<String, String> data) {
        ...
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "                              <h1 style=\"margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 700;\"><span>" + invitingUsername + " rejected your connection invitation</span></h1>\n" +
                ...
                "                        <tbody>\n" +
                "                          <tr>\n" +
                "                            <td style=\"overflow-wrap:break-word;word-break:break-word;padding:0px 0px 0px 22px;font-family:arial,helvetica,sans-serif;\" align=\"left\">\n" +
                "\n" +
                "                              <div>\n" +
                "                                <table>\n" +
                "                                  <tbody>\n" +
                "                                    <tr>\n" +
                "                                      <td>\n" +
                "                                        <img alt=\"inviterPicture\" src=\"" + inviterPicture + "\" style=\"width: 140px; height: 140px; border-radius: 100%; border: 4px solid red;\">\n" +
                "                                      </td>\n" +
                "                                      <td>\n" +
                "                                      </td>\n" +
                "                                    </tr>\n" +
                "                                    <tr>\n" +
                "                                      <td style=\"text-align: center; font-weight: 600; font-size: 1.2rem\">\n" +
                "                                        " + inviterUsername + "\n" +
                "                                      </td>\n" +
                "                                    </tr>\n" +
                "                                  </tbody>\n" +
                ...
                "\n" +
                "                              <table height=\"0px\" align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 5px solid #ff0000;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%\">\n" +
                "                                <tbody>\n" +
                "                                  <tr style=\"vertical-align: top\">\n" +
                ...
                "                                    <tr>\n" +
                "                                      <td>\n" +
                "                                        <img alt=\"invitingPicture\" src=\"" + invitingPicture + "\" style=\"width: 140px; height: 140px; border-radius: 100%; border: 4px solid red;\">\n" +
                "                                      </td>\n" +
                "                                      <td>\n" +
                "                                      </td>\n" +
                "                                    </tr>\n" +
                "                                    <tr>\n" +
                "                                      <td>\n" +
                "                                        <p style=\"text-align: center; font-weight: 600; margin-right: 3px; font-size: 1.2rem\">" + invitingUsername + "\n" +
                "                                        </p>\n" +
                "                                      </td>\n" +
                "                                    </tr>\n" +
                "                                  </tbody>\n" +
